...
export function directedSlide(
	...
	const paddingStartValue = parseFloat(style[`padding${capitalizedSecondaries[0]}`]);
	const paddingEndValue = parseFloat(style[`padding${capitalizedSecondaries[1]}`]);
	const marginStartValue = parseFloat(style[`margin${capitalizedSecondaries[0]}`]);
	const marginEndValue = parseFloat(style[`margin${capitalizedSecondaries[1]}`]);
	const borderWidthStartValue = parseFloat(style[`border${capitalizedSecondaries[0]}Width`]);
	const borderWidthEndValue = parseFloat(style[`border${capitalizedSecondaries[1]}Width`]);
